...

{
    ...
    public static implicit operator Bit8Value(Bit16Value a) => a.HighByte;
    ...
    public static Bit16Value operator |(Bit8Value a, Bit16Value b) => new()
    {
    ...
    public bool Equals(Bit8Value other) => other == this;

    public bool Equals(sbyte other) => other == (sbyte)Value;
